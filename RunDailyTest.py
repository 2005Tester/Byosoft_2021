...
"""
TC0 = {'id': 0, 'name':'boot_ubuntu',     'script': "\"C:\\autotest\\testcases\\BootUbuntu\\BootUbuntu.py\"",                   'exec':1}
TC1 = {'id': 1, 'name':'boot_to_shell',   'script': "\"C:\\autotest\\testcases\\BootoShell\\BootoShell.py\"",                   'exec':1}
TC2 = {'id': 2, 'name':'boot_to_setup',   'script': "\"C:\\autotest\\testcases\\BootToSetup\\BootToSetup.py\"",                 'exec':1}
TC3 = {'id': 3, 'name':'boot_to_bm',      'script': "\"C:\\autotest\\testcases\\BootToBootManager\\BootToBootManager.py\"",     'exec':1}
TC4 = {'id': 4, 'name':'sp_boot',         'script': "\"C:\\autotest\\testcases\\SpBoot\\SpBoot.py\"",                           'exec':1}
TC5 = {'id': 5, 'name':'boot_to_win2019', 'script': "\"C:\\autotest\\testcases\\BootWindows2019\\BootWindows2019.py\"",         'exec':1}
TC6 = {'id': 6, 'name':'legacy_boot',     'script': "\"C:\\autotest\\testcases\\LegacyBoot\\LegacyBoot.py\"",                   'exec':1}
TC7 = {'id': 7, 'name':'hpm_downgrade',   'script': "C:\\autotest\\testcases\\HpmDowngrade\\HpmDowngrade.py",                   'exec':1}
