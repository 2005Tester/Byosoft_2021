...
Cscript_Path = r"E:\Tools\Cscripts\SPR"
...
class Loc:
    ...
    # mirror 地址
    full_mirr_addr = 0x1_0000_0000

    arm_mirr_addr = 0x10_0000_0000
    arm_non_mirr_addr = 0x1000_0000
...
class Cmd:
    ...
    # ras 模块
    adddc_check = "ras.adddc_status_check(socket={}, mc={}, ch={})"#
    viral_check = "ras.viral_config_check()"
    viral_err = "ras.viral_error_check()"
    retry_rd = "ras.retry_rd_log_decode(socket={}, mc={}, ch={})"#
    emca_config = "ras.checkEMCA2Config()"
    emca_dump = "ras.dumpEMCA2logs({})".format(hex(Loc.EmcaL1DirAddr))
    ...
    scramble_cfg = "sv.socket{}.uncore.memss.mc{}.ch{}.mcscrambleconfig".format(
        Loc.msocket, Loc.imc, Loc.channel)
    demand_scrub_dis = "sv.socket{}.uncore.memss.m2mem{}.defeatures0.demandscrubwrdis"
    ...
    # MSR
    MCG_CAP = "msr(0x179)"
    MCG_CONTAIN = "msr(0x178)"
    MC0_CTL2 = "msr(0x280)"
    MCG_EXT_CTL = "msr(0x4d0)"
...
class TestCase:
    ...
    ADDDC = ["Testcase_MemRas_ADDDC_001",
             "Testcase_MemRas_ADDDC_002",
             "Testcase_MemRas_ADDDC_003",
             "Testcase_MemRas_ADDDC_004",
             "Testcase_MemRas_ADDDC_005",
             "Testcase_MemRas_ADDDC_006",
             "Testcase_MemRas_ADDDC_007",
             "Testcase_MemRas_ADDDC_008",
             "Testcase_MemRas_ADDDC_009",
             "Testcase_MemRas_ADDDC_010",
             "Testcase_MemRas_ADDDC_011",
             "Testcase_MemRas_ADDDC_012",
             "Testcase_MemRas_ADDDC_013",
             "Testcase_MemRas_ADDDC_014",
             "Testcase_MemRas_ADDDC_015",
             "Testcase_MemRas_ADDDC_016",
             "Testcase_MemRas_ADDDC_017",
             ]
    MIRROR = ["Testcase_MemRas_MirrorMode_001",
              "Testcase_MemRas_MirrorMode_002",
              "Testcase_MemRas_MirrorMode_003",
              "Testcase_MemRas_MirrorMode_004",
              "Testcase_MemRas_MirrorMode_005",
              "Testcase_MemRas_MirrorMode_006",
              "Testcase_MemRas_UEFIARMMirror_001",
              "Testcase_MemRas_UEFIARMMirror_002",
              "Testcase_MemRas_UEFIARMMirror_003",
              "Testcase_MemRas_UEFIARMMirror_004"
              ]
