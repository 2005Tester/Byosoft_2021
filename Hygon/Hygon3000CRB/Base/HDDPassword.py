...
HDD_NAME_02_OS=Sut01Config.Msg.HDD_NAME_02_OS
...
def hdd_password_003(hddorder):
    ...
    BmcLib.power_off()
    time.sleep(5)
    assert _del_hdd_password('hdd123@1')
    assert SetUpLib.enter_menu_change_value(Key.DOWN, SutConfig.HDDPassword.SET_HDDPASSWORD,10)
    if not SetUpLib.locate_option(Key.DOWN,[hddname],3):
        if not SetUpLib.locate_option(Key.UP,[hddname],3):
            time.sleep(1)
...
def hdd_password_004(hddorder):
    ...
    BmcLib.power_off()
    time.sleep(5)
    assert _del_hdd_password('Hdd1234@')
    assert SetUpLib.enter_menu_change_value(Key.DOWN, SutConfig.HDDPassword.SET_HDDPASSWORD,10)
    if not SetUpLib.locate_option(Key.DOWN,[hddname],3):
        if not SetUpLib.locate_option(Key.UP,[hddname],3):
            time.sleep(1)
...
def hdd_password_005(hddorder):
    ...
    BmcLib.power_off()
    time.sleep(5)
    assert _del_hdd_password('hdd123@22789')
    assert SetUpLib.enter_menu_change_value(Key.DOWN, SutConfig.HDDPassword.SET_HDDPASSWORD,10)
    if not SetUpLib.locate_option(Key.DOWN,[hddname],3):
        if not SetUpLib.locate_option(Key.UP,[hddname],3):
            time.sleep(1)
...
def hdd_password_006(hddorder):
    ...
    BmcLib.power_off()
    time.sleep(5)
    assert _del_hdd_password('hdd123@2278901234567890123456789')
    assert SetUpLib.enter_menu_change_value(Key.DOWN, SutConfig.HDDPassword.SET_HDDPASSWORD,10)
    if not SetUpLib.locate_option(Key.DOWN,[hddname],3):
        if not SetUpLib.locate_option(Key.UP,[hddname],3):
            time.sleep(1)
...
def hdd_password_007(hddorder):
    ...
    BmcLib.power_off()
    time.sleep(5)
    assert _del_hdd_password('hdd123@227890123456789012!@#$%^&')
    assert SetUpLib.enter_menu_change_value(Key.DOWN, SutConfig.HDDPassword.SET_HDDPASSWORD,10)
    if not SetUpLib.locate_option(Key.DOWN,[hddname],3):
        if not SetUpLib.locate_option(Key.UP,[hddname],3):
            time.sleep(1)
...
def hdd_password_008(hddorder):
    ...
    if SetUpLib.wait_message_enter(SutConfig.Msg.SET_HDD_PSW_SUCCESS, 5):
        ...
        return
    time.sleep(2)
    if SetUpLib.wait_message_enter('Enter Current Password',3):
        time.sleep(1)
        SetUpLib.send_data_enter('hdd123@1')
    time.sleep(1)
...
def hdd_password_009(hddorder):
    ...
    BmcLib.power_off()
    time.sleep(5)
    assert _del_hdd_password('hdd111@1')
    assert SetUpLib.enter_menu_change_value(Key.DOWN, SutConfig.HDDPassword.SET_HDDPASSWORD,10)
    if not SetUpLib.locate_option(Key.DOWN,[hddname],3):
        if not SetUpLib.locate_option(Key.UP,[hddname],3):
            time.sleep(1)
    ...
    time.sleep(1)    
    SetUpLib.send_data('hdd123@227890123456789012!@#$%^&')
    if SetUpLib.wait_message_enter(Sut01Config.Msg.SET_HDD_PSW_SUCCESS, 5):
        time.sleep(1)
        SetUpLib.send_key(Key.ENTER)
        logging.info('修改硬盘密码成功')
        time.sleep(1)
