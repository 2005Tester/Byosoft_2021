...
from Hygon7500CRB.BaseLib import  SetUpLib, BmcLib
from Hygon7500CRB.Base import Update
...
def setup_upgrade_all(bios_mode='latest',change_part='all'):
...
def setup_keep_all(bios_mode='latest',change_part='all'):
...
def dos_keep_normal(bios_mode='latest',change_part='all'):
...
def dos_keep_all(bios_mode='latest',change_part='all'):
...
def shell_keep_normal(bios_mode='latest',change_part='all'):
...
def shell_keep_all(bios_mode='latest',change_part='all'):
...
def linux_keep_normal(bios_mode='latest',change_part='all'):
...
def linux_keep_all(bios_mode='latest',change_part='all'):
