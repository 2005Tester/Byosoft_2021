...
TestRunInfo = {"testPass":1,
    "testResult":[
        ...
        {"className":"Legacy Boot ","methodName":"TC6","description":"Legacy Boot (No bootable device)","spendTime":"0s","status":"","log":[]},
        {"className":"HPM Downgrade ","methodName":"TC7","description":"Downgrdae to last official release using hpm","spendTime":"0s","status":"","log":[]}
	],
    "testName" :'',
    "testAll"  :'8',
	"testPass" :'',
