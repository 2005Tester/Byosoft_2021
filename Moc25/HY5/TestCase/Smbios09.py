...
from HY5.Config.PlatConfig import BiosCfg, Msg
from HY5.BaseLib import BmcLib
...
def smbios_type128():
    ...
    try:
        ...
        assert BmcLib.force_reset()
        ser_rmt_data = SerialLib.cut_log(Sut.BIOS_COM, "START_BSSA_RMT", "Lane Margin", duration=180, timeout=1500)
        assert ser_rmt_data, "Invalid RMT data"
        assert MiscLib.ping_sut(SutConfig.Env.OS_IP, 1500)
