...
#     excmd(Cmd.inj_mem.format(_inject_a), delay=Delay.mem_ce, _halt=False, _go=False)
#     _inject_b = f"socket={Loc.msocket}, channel={Loc.ch}, dimm={Loc.dimm}, rank={Loc.rank}, bank_group=2, bank=2, errType='ce'"
#     excmd(Cmd.inj_mem.format(_inject_b), delay=Delay.mem_ce, _halt=False, _go=False)
#     _inject_c = f"socket={Loc.msocket}, channel={Loc.ch}, dimm={Loc.dimm}, rank={Loc.rank}, bank_group=3, bank=2, errType='ce'"
#     excmd(Cmd.inj_mem.format(_inject_c), delay=Delay.mem_ce, _halt=False, _go=False)
#     itp.go()
...
def Testcase_GPIORAS_002():
    ...
    excmd(Cmd.adddc_check.format(Loc.msocket, Loc.imc, Loc.channel))
...
def Testcase_PageOffline_001():
    ...
    shell_cmd("dmesg", Testcase_PageOffline_001.__name__)
    os_ssh.close_shell()
...
def Testcase_PageOffline_002():
    ...
    os_ssh.exec_cmds(["dmesg -C\n"])
    inj_mem(count=2, bank_group=1, bank=1, errType="ce")
    shell_cmd("dmesg", Testcase_PageOffline_002.__name__)
