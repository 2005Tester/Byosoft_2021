...
from batf.TcExecutor import TestScope, CliParse
...
class ReportGenerator:
            ...
            for line in f.readlines():
                if line and line != '\n':
                    ...
                    if re.search('&lt;img src=', line) or re.search('&lt;span', line):
                        for i in ['&lt;img src=','&lt;span','&lt;/span']:
                            line = line.replace(i,'<'+i[4:])
                    all_log.append(line)
        return all_log
    ...
    def write_to_html(self):
        ...
        with open(self.template, 'r', encoding='utf-8') as f:
            ...
            com = re.compile('>[\w\s]+Test Report')
            data = com.sub(f'>{var.get("project")} {CliParse().get_execution_type()} Test Report', data)
