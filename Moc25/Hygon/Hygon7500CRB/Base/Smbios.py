...
def get_smbios():
    ...
    shutil.rmtree('Hygon/Tools/SMBIOS')
    os.mkdir('Hygon/Tools/SMBIOS')
    ...
    while True:
        for type in types:
            ...
            SshLib.sftp_download_file(Sut.OS_SFTP,type_file_linux,'Hygon/Tools/SMBIOS/{0}'.format(type_file))
            for root, dirs, files in os.walk('Hygon/Tools/SMBIOS'):
