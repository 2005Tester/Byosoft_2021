...
class Cmd:
    ...
    adddc_sparing = "sv.socket{}.uncore.memss.mc{}.ch{}.sparing_control.adddc_sparing".format(
        Loc.msocket, Loc.imc, Loc.channel)
    set_temp_lo = "sv.socket{}.uncore.memss.mc{}.ch{}.dimm_temp_th_{}.temp_lo=0x0".format(
        Loc.msocket, Loc.imc, Loc.channel, Loc.dimm)
    set_temp_mid = "sv.socket{}.uncore.memss.mc{}.ch{}.dimm_temp_th_{}.temp_mid=0x0".format(
        Loc.msocket, Loc.imc, Loc.channel, Loc.dimm)
    ...
    comp_timeout_severity = "sv.socket{}.uncore.pcie.{}.cfg.erruncsev.ctes=1".format(
